                         ...
                         <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                   ...
                                   <td><img src="{{URL::to('public/uploads/product/' .$edit_value->brand_name )}}" height="100" width="150">  </td>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Mô tả danh mục</label>
                                    <textarea style="resize: none;" rows="5" type="password" name="brand_product_desc" class="form-control" id="ckeditor3" >{{ $edit_value->brand_name }}</textarea>
                                </div>
